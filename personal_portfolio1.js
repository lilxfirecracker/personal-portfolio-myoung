...
function danceButton() {
  window.scrollTo(0, 275); // For Chrome, Firefox, IE and Opera
}

function skateButton() {
  window.scrollTo(0, 600); // For Chrome, Firefox, IE and Opera
}
...
function init() {
	...
	ourLoc = ol.proj.fromLonLat([37.776781, -122.416792]);
